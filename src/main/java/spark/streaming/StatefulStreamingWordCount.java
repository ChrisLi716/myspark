...
public class StatefulStreamingWordCount {
	...
	/**
	 * VM options:-Dspark.master=local[3]
	 * 
	 * @param args Program arguments: /tmp/checkpoint localhost 9990
	 * @throws Exception
	 */
	...
	public static JavaStreamingContext createContext(String checkPointDir, String host, int port) {
		...
		JavaPairDStream<String, Integer> wordPairs = words.mapToPair(w -> new Tuple2<String, Integer>(w, 1));
